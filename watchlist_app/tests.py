...
# from watchmate.rest_framework import response
# from rest_framework.status import HTTP_403_FORBIDDEN

class StremPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.stream = models.StreamPlatform.objects.create(name="Netfllix",about="#1 platform", website="https://www.netflix.com")
...
class ReviewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.stream = models.StreamPlatform.objects.create(name="Netflix", about="#1 platfrom", website="https://www.netflix.com")
        self.watchlist = models.WatchList.objects.create(platform = self.stream, title="example", storyline = "example movie", active=True)

        self.watchlist2 = models.WatchList.objects.create(platform = self.stream, title="example", storyline = "example movie", active=True)
